...
const ProfileCard = (props) => {
 ...
 <br/>
    ...
    <div className="profile-container06">
      ...
      <h3 className="profile-text Text2XL">{props.name}</h3>
...
location: 'Imus, Cavite, Philippines',
  name: '',
  twitterlink:'https://shop.sb19music.com/',
  fblink:'https://shop.sb19music.com/',
  instalink:'https://shop.sb19music.com/',
  position: 'Leader, Main Rapper, Lead Vocalist',
  image_src: '/playground_assets/pablo.jpg',
  place: ' Imus, Cavite, Philippines',
  avatar_alt: 'avatar',
  description:
