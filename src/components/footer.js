      ...
      <div className="footer-container01">
        <div className="footer-container02">
          <h1 className="footer-text TextXL">
            <span>Follow and Visit Us</span>
          </h1>
          <span className="footer-text02">
            Follow and know more about SB19 in other social media platforms.
          </span>
          <div className="footer-container03">
            <div className="footer-container04">
              <a href="https://twitter.com/SB19Official">
          ...
          <svg
            ...
            <div className="footer-container06">
              <a href="https://www.facebook.com/SB19Official/"> 
            ...
            <div className="footer-container07">
              <a href="https://www.instagram.com/officialsb19/">
              <svg
                viewBox="0 0 877.7142857142857 1024"
        ...
        <div className="footer-container08">
          <div className="footer-container09">
            <span className="footer-text03 TextXS">Other Links</span>
            <span className="footer-text04 TextSM"><Link to="/developers">About Developer</Link></span>
            <span className="footer-text05 TextSM"><a href="https://shop.sb19music.com/">SB19 Official Store</a></span>
            <span className="footer-text06 TextSM"><a href="https://www.youtube.com/@SB19OfficialYT">SB19 Official Youtube</a></span>
            <span className="footer-text07 TextSM"><a href="https://www.youtube.com/c/ShowBTEntertainment">SHOW BT Philippines Youtube</a></span>
          </div>
        </div>
      </div>
      <div className="footer-container11"></div>
      <span className="footer-text13 TextSM">Copyright © 2023 SB19</span>
    </div>
  );
};
